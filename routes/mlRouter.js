...
import { fetchHealthRisk,getPatientModeldata ,modelbyid, whatif ,LLMModelData,LLMModelDoctorData} from '../controllers/mlController.js';
...
mlRouter.get('/model/LLM', authenticatePatient,LLMModelData);
mlRouter.get('/recommendations/:patientId', authenticateDoctor, LLMModelDoctorData);
